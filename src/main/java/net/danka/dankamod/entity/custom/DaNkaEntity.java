package net.danka.dankamod.entity.custom;
...
public class DaNkaEntity extends AnimalEntity {

    public DaNkaEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createDaNkaAttributes() {
    ...
    public @Nullable PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.DANKA.create(world);
    }
}
